...
Select_Form_1099MISC
  ...
  #FOR    ${i}    IN RANGE    2    ${rows}+1
	${Businessdata}=       Get cell value    5    A   RecipientDetails
  ...
  FOR    ${i}    IN RANGE    2    ${rows}+1
	${RecipientTIN}=       Get cell value    ${i}    C   RecipientDetails
	${Rents}=       Get cell value    ${i}    D   RecipientDetails
	${Royalties}=       Get cell value    ${i}    E   RecipientDetails
	${Other}=       Get cell value    ${i}    F   RecipientDetails
	${Federal}=       Get cell value    ${i}    G   RecipientDetails
	${Fishing}=       Get cell value    ${i}    H   RecipientDetails
	${Medical}=       Get cell value    ${i}    I   RecipientDetails
	${Substitute}=       Get cell value    ${i}    K   RecipientDetails
	${Crop}=       Get cell value    ${i}    L   RecipientDetails
	${Gross}=       Get cell value    ${i}    M   RecipientDetails
	${Fish}=       Get cell value    ${i}    N   RecipientDetails
	${Section}=       Get cell value    ${i}    O   RecipientDetails
	${Excess}=       Get cell value    ${i}    P   RecipientDetails
	${Nonqualified}=       Get cell value    ${i}    Q   RecipientDetails
